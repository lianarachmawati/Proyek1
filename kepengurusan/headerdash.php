...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
    ...
    <div class="icon ml-auto">
      <h5><a href="../index.php"><i class="fas fa-home mr-2 color-black" data-toggle="tooltip" title="BERANDA"></i></a><a href="../logout.php"> <i class="fas fa-sign-out-alt mr-3" data-toggle="tooltip" title="LOGOUT"></i></a>
      </h5>
    </div>
  </nav>
  <div class="row no-gutters mt-5">
    <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
     <ul class="nav flex-column ml-3 mb-5">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="datakegiatan.php"><i class="fas fa-chart-line mr-2"></i>Data Kegiatan</a><hr class="bg-secondary">
      </li>
      <li class="nav-item">
